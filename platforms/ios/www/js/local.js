...
var fillAd, fillBucket, getAd, getAdWithGPS, getBucket, getBucketWithGPS, getBusinessForm, onGPSAdSuccess, onGPSBucketSuccess, onGPSError, onLoad, onPictureFail, onTransferFail, onTransferSuccess, roundDistanceForAds, roundDistanceOfAd, selectPhoto, shareAdSocially, startApp, uploadPhoto;
...
uploadPhoto = function(imageURI) {
  ...
  ft = new FileTransfer();
  return ft.upload(imageURI, encodeURI("http:0.0.0.0:3000/business/new"), onTransferSuccess, onTransferFail, options);
};
