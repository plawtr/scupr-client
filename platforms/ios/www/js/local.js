...
Handlebars.registerHelper('createTag', function(tag) {
  return new Handlebars.SafeString("<button onclick=\"getTagBucketWithGPS(\"" + tag + "\");\" data-tag=\"" + tag + "\" style=\"line-height: 18px; min-height: 0px; margin-bottom: 3px;\" class=\"button button-outline button-small button-positive\">" + tag + "</button>");
});
